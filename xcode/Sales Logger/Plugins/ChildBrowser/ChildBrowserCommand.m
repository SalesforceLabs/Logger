...
#import "SalesforceHybridSDK/CDVViewController.h"
...
/*    if (self.childBrowser == nil) {
    ...
    // need close childbrowser session otherwise it will have error "child browser is already active" when opening again.
    [self onClose];
